...
1. Run the full randos test suite (see [common scripts](#common-scripts)),
...
1. In GitHub, send a pull request to `randos:main`.

- If we suggest changes then:

  - Make the required updates.
  - Re-run the randos test suites to ensure tests are still passing.
...
we use the git commit messages to **generate the randos change log**.
...
- **ui**: for changes made on `projects/ui` directory

If your change affect more than one package, separate the scopes with a comma (e.g. `ui,scope2`).
...
[github]: https://github.com/MHarmony/randos
[new_issue]: https://github.com/MHarmony/randos/issues
[gh_prs]: https://github.com/MHarmony/randos/pulls
